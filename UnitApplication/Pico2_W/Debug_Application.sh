...
launch_gdb 0 "./Tools/GDB_and_OpenOCD/StartGDB_Core0_app.sh"

# Launch GDB for core1
#launch_gdb 1 "./Tools/GDB_and_OpenOCD/StartGDB_Core1_app.sh" //TODO - core 1 not working properly right now, only core 0 supported
